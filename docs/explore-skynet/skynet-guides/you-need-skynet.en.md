...
Let’s say your favorite portal has a limit for a maximum upload of 1GB. If you need more, you have two options. To use some Skynet app that works around that limit, for example as SkySend ([see our guide here](/explore-skynet/skynet-guides/sending-files.en.html)).
...
Just change the domain name in the skylink to something else. Find a list (may be incomplete) [here](/how-does-it-work/skynet-guides/portals.en.html).
...
> [How To: Sending Large Files over Skynet](/explore-skynet/skynet-guides/sending-files.en.html)
