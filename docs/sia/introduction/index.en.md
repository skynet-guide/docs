...
Check our [Mining Guide](/sia/mining-guide/index.en.html) if you want to learn more.
...
Where to continue from here? Try [Introduction to Skynet.](/skynet/introduction/index.en.html)

>You can find more details of Sia’s early days in the [History](/sia/history/index.en.html) section.
