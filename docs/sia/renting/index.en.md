...
>Side note, Skynet does not use erasure coding because it wasn’t fast enough on release, learn more in [Introduction to Skynet](/skynet/introduction/index.en.html). Again, as stated earlier, this is somewhat changing.
...
### Setting up a renter
To set up a renter, follow the steps in [Renting on Sia](/rent/renting-on-sia/index.en.html).
