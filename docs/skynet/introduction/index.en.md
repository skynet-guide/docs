...
Before reading this article, you should read the [Introduction to Sia](/sia/introduction/index.html) article and the technical side of renting article to have a better bearing of how everything works, and who is behind the project. While the top level ideas can be grasped pretty easily, the design behind Sia can be pretty complex, so keep that in mind.
...
Unfortunately, as of today you cannot just run a Skynet portal in your browser (though this is being worked on by the [Sia Foundation](/sia/foundation/index.html) with [Utreexo](https://forum.sia.tech/t/core-development-utreexo/54/14) support). Due to the many limitations of running a Sia full node talked about in the [Before You Start](/renting/before-you-start/index.html) article, running a renter node is hard on your system. The main hard parts are:
...
>Discover more [Skynet Apps](/discover/skynet-apps/index.html).
