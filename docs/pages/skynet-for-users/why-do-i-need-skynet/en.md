...
Let’s say your favorite portal has a limit for a maximum upload of 1GB. If you need more, you have two options. To use some Skynet app that works around that limit, for example as SkySend ([see our guide here](/pages/skynet-for-users/sending-files-over-skynet/en.html)).
...
Just change the domain name in the skylink to something else. Find a list (may be incomplete) [here](/pages/skynet/portals/en.html).
