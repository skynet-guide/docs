# Setting up Siacentral Host Manager on a remote PC
This is a technical guide to setting up Siacentral's Host Manager to connect to a remote . To learn more about the basics of Sia hosting read our [hosting article](/guides/sia/hosting/introduction.html). This guide should be similar for any other Linux distributions.
